...
// designer text
firstText = "Shopify App Developer";
secondText = "Shopify Theme Developer";
thridText = "Web Developer"
fourthText = "Full Stack Developer"
fivethText = "MERN Stack Developer"
intervalTime = 600;
...
function displayText() {
    ...
    setTimeout(() => {
        document.querySelector('.designer').innerText = fivethText;
    }, intervalTime * 11);
}
setInterval(() => {
    displayText();
...
// hire me btn navigate to contact from 
...
$(document).ready(function() {
    $('.hire_me').on('click', function(e) {
        ...
        $('#icetab-container .icetab').last().addClass('current-tab');
        
        // Content switch
        $('.tabcontent').removeClass('tab-active');
        $('#contact').addClass('tab-active');
